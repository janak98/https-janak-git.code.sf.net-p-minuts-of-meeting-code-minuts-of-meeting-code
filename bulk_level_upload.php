...
<div class="container py-5">
  <h2 class="text-center mb-4">📶 Level Data Upload</h2>
  <div class="row justify-content-center g-4">
    ...
    <div class="col-md-6">
      <div class="upload-panel text-center">
        ...
        <div class="upload-desc">Use an Excel file to upload multiple levels at once.</div>

      <form action="upload_level.php" method="post" enctype="multipart/form-data">
        <input type="file" name="excelFile" accept=".xls,.xlsx" class="form-control mb-2" required></br>
        <button type="submit" class="btn btn-primary upload-btn">Upload Levels</button>
      </form>
    </div>
